...
class GPSRTKSimulation(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("GPS-Denied Multi-Vehicle RTK Simulation with A* Path Planning")
    ...
    def create_control_panel(self, main_layout):
        ...
        control_panel.setFixedWidth(480)  # Increased width for better rover status display
    ...
    def trigger_replanning(self, rover):
        ...
        if nearest_base:
            ...
            if path:
                ...
                world_path = [self.grid_to_world(grid_pos) for grid_pos in path[1:]]  # Skip current position
    ...
    def update_rover_status(self):
        ...
        for i, rover in enumerate(self.rovers):
            ...
            gps_color = "#4CAF50" if rover.has_gps else "#f44336"  # Light green/red for dark theme
    ...
    def update_performance_metrics(self):
        ...
        total_possible = len(self.rovers) * len(self.base_stations)  # 4 rovers * 3 base stations = 12
    ...
    def update_plot(self):
        ...
        self.ax_main.set_title("GPS-Denied Multi-Vehicle RTK Simulation with A* Path Planning", 
        ...
        for center_x, center_y, radius in self.obstacles:
            circle = plt.Circle((center_x, center_y), radius, color="gray", alpha=0.5, label="Obstacle")
            self.ax_main.add_artist(circle)
        ...
        for rover in self.rovers:
            ...
            for base_station in self.base_stations:
                # Use base station range (adjustable by slider) instead of rover transceiver range
                if np.linalg.norm(rover.true_pos - base_station.true_pos) <= base_station.comm_range:
    ...
    def on_drag(self, event):
        ...
        # Draw preview
        self.drawing_state['temp_circle'] = plt.Circle(start, radius, color="red", alpha=0.3)
